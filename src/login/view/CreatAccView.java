 ...
 * @author teste
 */
public class CreatAccView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonSave = new javax.swing.JToggleButton();
        ...
        getContentPane().add(jPasswordFieldPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 300, 230, -1));

        jTextFieldEmail.setBackground(new java.awt.Color(255, 255, 255));
        jTextFieldEmail.setForeground(new java.awt.Color(0, 0, 0));
        getContentPane().add(jTextFieldEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 230, 230, -1));

        jButtonSave.setBackground(new java.awt.Color(105, 137, 170));
        jButtonSave.setFont(new java.awt.Font("Gill Sans MT", 0, 18)); // NOI18N
        ...
        getContentPane().add(jButtonSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 350, 110, 40));
        ...
        getContentPane().add(jTextFieldName, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 160, 230, -1));
    ...
    private void jButtonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveActionPerformed
        ...
        if(jTextFieldName.getText().matches("") || 
                jTextFieldEmail.getText().matches("") || 
                jPasswordFieldPassword.getText().matches("")){
        ...
        try {
            register.newRegistUser(this);
        } catch (SQLException ex) {
            Logger.getLogger(CreatAccView.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        JOptionPane.showConfirmDialog(rootPane, "Cadastro realizado com sucesso");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreatAccView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreatAccView().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JToggleButton jButtonSave;
